/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ga.jsonc --env=layal --env-file=.dev.vars.example --strict-vars=false types/worker-configuration.d.ts` (hash: 8d9db978feceba2c7f87134a547437d1)
// Runtime types generated with workerd@1.20260903.1 2026-09-04 global_fetch_strictly_public,nodejs_compat
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../src/ga-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BRAND_SLUG" | "BRAND_LABEL" | "BRAND_SITE_URL" | "GA_ACCOUNT_ID" | "GA_ACCOUNT_NAME" | "GA_PROPERTY_ID" | "GSC_SITE_URL" | "GOOGLE_SERVICE_ACCOUNT_KEY" | "MCP_LOGIN_PASSWORD">> {}
}
